...
import sec21 from '../assets/Image/sec-21.png'
import sec22 from '../assets/Image/sec-22.png'
import sec23 from '../assets/Image/sec-23.png'
...
function Cautusdescripition() {
    ...
    return (
        <>
            ...
            >
                <h2 className="fw-bold"> Cactus</h2>
            </div>
            <div className="container my-5">
                <div className="row  align-items-stretch">
                    <div className="col-md-6">
                        <div className="galleryTerrace-plant">
                            <img className="img1 img-grid" src={sec21} alt="img1" />
                            <img className="img2 img-grid" src={sec22} alt="img2" />
                            <img className="img3 img-grid" src={sec23} alt="img3" />
                            <img className="img4 img-grid" src={sec21} alt="img4" />
                        </div>
                    </div>

                    {/* Right */}
                    <div className="col-md-6 plant">
                        <h2 className="mb-3"> Christmas Cactus</h2>
                        ...
                        <h4 className="fs-4 fw-semibold">₹ 1850</h4>
                    ...
                    <div className="col-12 col-sm-6 col-md-3 mb-4">
                        <div className="card text-center h-100 border-0">
                            <div className="card-img-wrapper">
                                ...
                                <div className="card-hover-icons">
                                    <button className="icon-btn" onClick={() => handleAddCart({ name: 'Epipremnum Aureum', price: 350, image: 3 })}>
                                        <i className="bi bi-cart3"></i>
                                    </button>
...
export default Cautusdescripition