...
import sec4 from '../assets/Image/sec-4.png'
import sec5 from '../assets/Image/sec-5.png'
                ...
                <div className="row  align-items-stretch">
                    <div className="col-md-6">
                        <div className="galleryTerrace-plant">
                            <img className="img1 img-grid" src={sec4} alt="img1" />
                            <img className="img2 img-grid" src={sec5} alt="img2" />
                            <img className="img3 img-grid" src={sec4} alt="img3" />
                            <img className="img4 img-grid" src={sec5} alt="img4" />
                        </div>
                    </div>

                    {/* Right */}
                    <div className="col-md-6 plant">
                        <h2 className="mb-3">Sunset Oasis</h2>
                        ...
                        <h4 className="fs-4 fw-semibold">₹ 540</h4>
      ...
      <div className="card text-center h-100 border-0">
        <div className="card-img-wrapper">
          ...
          <div className="card-hover-icons">
            <button
              className="icon-btn"
              onClick={() => handleAddCart({ name: 'Chlorophytum Coso', price: 190, image: plants5, quantity: 1 })}
            >
              <i className="bi bi-cart3"></i>
            </button>
            <button
              className="icon-btn"
              onClick={() => handleAddToWishlist({ name: 'Chlorophytum Coso', price: 190, image: plants5 })}
            >
      ...
      <div className="card text-center h-100 border-0">
        <div className="card-img-wrapper">
          ...
          <div className="card-hover-icons">
            <button
              className="icon-btn"
              onClick={() => handleAddCart({ name: 'Zamioculcas', price: 390, image: plants6, quantity: 1 })}
            >
              <i className="bi bi-cart3"></i>
            </button>
            <button
              className="icon-btn"
              onClick={() => handleAddToWishlist({ name: 'Zamioculcas', price: 390, image: plants6 })}
            >
              <i className="bi bi-heart"></i>
            </button>
          </div>
      ...
      <div className="card text-center h-100 border-0">
        <div className="card-img-wrapper">
          ...
          <div className="card-hover-icons">
            <button
              className="icon-btn"
              onClick={() => handleAddCart({ name: 'Spathiphyllum', price: 220, image: plants7, quantity: 1 })}
            >
              <i className="bi bi-cart3"></i>
            </button>
            <button
              className="icon-btn"
              onClick={() => handleAddToWishlist({ name: 'Spathiphyllum', price: 220, image: plants7 })}
            >
              <i className="bi bi-heart"></i>
            </button>
          </div>
      ...
      <div className="card text-center h-100 border-0">
        <div className="card-img-wrapper">
          ...
          <div className="card-hover-icons">
            <button
              className="icon-btn"
              onClick={() => handleAddCart({ name: 'Philodendron', price: 410, image: plants8, quantity: 1 })}
            >
              <i className="bi bi-cart3"></i>
            </button>
            <button
              className="icon-btn"
              onClick={() => handleAddToWishlist({ name: 'Philodendron', price: 410, image: plants8 })}
            >
              <i className="bi bi-heart"></i>
            </button>
          </div>
...
export default ImageDescripition