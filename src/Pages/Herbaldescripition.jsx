...
import sec15 from '../assets/Image/sec-15.png'
import sec16 from '../assets/Image/sec-16.png'
import sec17 from '../assets/Image/sec-17.png'
...
function Herbaldescripition() {
    ...
    return (
        <>
            ...
            >
                <h2 className="fw-bold">Herbal Indoor Plants</h2>
            </div>
            <div className="container my-5">
                <div className="row  align-items-stretch">
                    <div className="col-md-6">
                        <div className="galleryTerrace-plant">
                            <img className="img1 img-grid" src={sec15} alt="img1" />
                            <img className="img2 img-grid" src={sec16} alt="img2" />
                            <img className="img3 img-grid" src={sec17} alt="img3" />
                            <img className="img4 img-grid" src={sec15} alt="img4" />
                        </div>
                    </div>
                    ...
                    <div className="col-md-6 plant">
                        ...
                        <h4 className="fs-4 fw-semibold">₹ 220</h4>
...
export default Herbaldescripition