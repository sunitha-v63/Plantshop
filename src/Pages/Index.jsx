    ...
    <>
        ...
        <div className="container">
          <div className="row align-items-center text-center text-md-start">
            ...
            <div className="col-12 col-md-6 text-center">
              ...
              <button className="btn btn-success px-4 py-2" onClick={handleRegister}>Register</button>
        ...
        <div className="container py-5">
          <div className="row align-items-center flex-column-reverse flex-md-row">
            <div className="col-md-5 text-center text-md-start" style={{ fontSize: "17px", fontWeight: "600" }}>
              <p>
                A houseplant, also known as a pot plant, potted plant, or indoor plant, is an ornamental plant cultivated indoors for aesthetic or practical purposes...
              </p>
              <button className="btn mb-4" style={{ backgroundColor: 'white', color: '#198754', fontSize: "16px", fontWeight: "600" }}>
      ...
      <div className="container py-5">
        <div className="text-center mb-4 home-container4">
          ...
          <div className="mt-4">
            <button type="button" className="btn btn-link text-decoration-none fw-semibold ">
              All Plants
            </button>
        ...
        <div className="text-center mt-3">
          <button className="btn btn-white border-success px-6 py-6 fs-4" style={{ color: "#0D4F36", fontWeight: "bold" }}>
        ...
        <div className="container py-5">
          <div className="row align-items-center">
            ...
            <div className="col-md-7 text-center text-md-start">
              ...
              <div>
                <button className="btn btn-white border-success px-6 py-6 fs-4" style={{ color: "#0D4F36", fontWeight: "bold", margin: "0 18%" }}>
          ...
          <div className="col">
            <div className="card h-100 border-0">
              ...
              <div className="card-body" style={{ backgroundColor: "#EAF6EF" }}>
                ...
                <button className="btn" style={{ backgroundColor: "#0D4F36", color: "white" }} >Read More</button>
              </div>
            </div>
          </div>
